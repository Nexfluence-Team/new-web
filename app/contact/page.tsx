 ...
 * layout constraints as the company homepage and about page.
 *
 * Sections:
 *  1. Header (shared)
 *  2. Contact Hero
 *  3. Contact Form + Info Cards (bento grid)
 *  4. Visit Us (map placeholder)
 *  5. Final CTA
 *  6. Footer (shared)
 *
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Btn href="#contact-form" variant="primary">
            Send a Message ↓
          </Btn>
...
// ─────────────────────────────────────────────
// CONTACT FORM + INFO CARDS (BENTO GRID)
// ─────────────────────────────────────────────
      ...
      >
        ...
        >
          ...
          <InfoCard
            icon="🕐"
            title="Office Hours"
            lines={["Mon–Fri: 10:00 – 18:00", "Sat–Sun: Closed"]}
            accent={C.indigo}
          />
        </div>
      </div>
...
function VisitUs() {
  ...
  return (
    <section style={siteOuter(w)}>
      ...
      >
        <Image
          src="/contact-map.webp" /* ← replace with actual map image or embed */
          alt="Nexfluence office location"
          fill
        ...
        >
          ...
          <p style={{ fontSize: 13, color: C.inkDim, margin: "4px 0 0" }}>
            Brīvības iela 123, Riga
          </p>
        </div>
      </div>
    </section>
...
// ─────────────────────────────────────────────
// FINAL CTA (adapted for contact page)
// ─────────────────────────────────────────────
function FinalCTA() {
  const w = useWindowWidth();
  const isMobile = w < 640;
    ...
    <section style={{ ...siteOuter(w, 96), marginBottom: 0 }}>
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <Btn href="mailto:hello@nexfluence.eu" variant="primary">
            Start Now →
          </Btn>
        </div>
      </div>
